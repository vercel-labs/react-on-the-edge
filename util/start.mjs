...
// we need to redefine it because the import of `edge-runtime`
// is side-effectful and fucks with process listeners
// https://bit.ly/3bokZeo
...
// because edge-runtime doesn't support the modern module
// format, we have to combine it with a shim that appends
